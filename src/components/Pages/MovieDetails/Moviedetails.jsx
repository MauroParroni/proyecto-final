    ...
    <div>
      {movie && (
        <>
          ...
          {/* Movie Details */}
          <div className="movie-details-content d-flex flex-column flex-sm-row justify-content-center align-items-center text-center">
            ...
            <div>
              ...
              <p>
                <strong>Duración:</strong> {Math.floor(movie.runtime / 60)}h{" "}
          ...
          {recommendedMovies.length > 0 && (
            <RecommendationCarousel
              recommendedItems={recommendedMovies}
              type="movie"
            />
          )}
        </>
